// Insertion in a singly linked list of integers at specific location.
#include <stdio.h>
#include <stdlib.h>
...
int main()
{
    int n,num1,a,insPlc;
    stnode = NULL;
	printf("\n\n Circular Linked List : Insertion of a node at any position in  a circular linked list :\n");
	printf("--------------------------------------------------------------------------------------\n");	   	
    ...
    a=1;
    displayClList(a);
	printf(" Enter the position where to insert a new node : ");
    scanf("%d", &insPlc);
    printf(" Enter the data for the position %d : ", insPlc);
    scanf("%d", &num1);
